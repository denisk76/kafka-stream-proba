...
public class KafkaStreamsConfiguration {
    ...
    public static final String TRANSACTIONS_TOPIC_NAME = "bms-transactions";
    public static final String RESULT_TOPIC_NAME = "bms-transactions2";
    ...
    public KStream<String, BmsTransaction> transactionStream(StreamsBuilder builder) {
        ...
        KStream<String, BmsTransaction> stream = builder.stream(TRANSACTIONS_TOPIC_NAME, Consumed.with(stringSerde, TerminalOperationSerde))
        ...
        stream.to(RESULT_TOPIC_NAME, Produced.with(stringSerde, bmsTransactionSerde));
